...
def make_default_config(tmp) -> dict:
    ...
    config['default_small']['mem_mb'] = 500
    config['default_small']['time'] =  5
    #default - mid
    config['default_mid']=dict()
    config['default_mid']['mem_mb'] = 4000
    config['default_mid']['time'] =  10
    #default - high
    config['default_high']=dict()
    config['default_high']['mem_mb'] = 20000
    config['default_high']['time'] =  20
